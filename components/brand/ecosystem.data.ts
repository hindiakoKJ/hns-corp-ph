...
export const ECO_PRODUCTS: EcoProduct[] = [
  ...
  { key: 'MagnetMoments', name: 'Magnet Moments',accent: '#D4A94A', kind: 'Custom fridge magnets, cut to the mm',     status: 'live', href: '/magnetmoments',                     logo: '/logos/magnetmoments-icon.png' },
  { key: 'MyMoments',     name: 'MyMoments',     accent: '#E0656A', kind: 'RSVP sites for every celebration',        status: 'live', href: '/mymoments', isNew: true,          logo: '/logos/mymoments-icon.svg' },
