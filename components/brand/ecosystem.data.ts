...
export const ECO_PRODUCTS: EcoProduct[] = [
  ...
  { key: 'CVAssist',      name: 'CVAssist',      accent: '#4F46E5', kind: 'AI job-application co-pilot',              status: 'live', href: 'https://cvassist.cc',               logo: '/logos/cvassist-icon.svg' },
  ...
  { key: 'Steady',        name: 'Steady',        accent: '#37D9A0', kind: 'Health companion — seizure logging',      status: 'soon', href: 'https://steady.hnscorpph.com',      logo: '/logos/steady-icon.png' },
